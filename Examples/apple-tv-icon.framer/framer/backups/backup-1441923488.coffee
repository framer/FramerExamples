...
bg.on Events.TouchMove, (event) ->
	...
	settings.y = Utils.modulate -delta.y, [0, settingsLayer.midX], [130, 115]
	settings.x = Utils.modulate -delta.x, [0, settingsLayer.midY], [100, 85]
	...
	glow.x= Utils.modulate delta.x, [0, settingsLayer.midX], [-100, 200]
	glow.opacity= Utils.modulate delta.x, [0, settingsLayer.midX], [0.3, 1]
	glow.y= Utils.modulate delta.y, [0, settingsLayer.midY], [10, 300]
