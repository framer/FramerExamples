...
# Titlebar reset before Animation
...
user1.on Events.TouchEnd, ->
	user1.animate
		...
		user2.states.next(["darken", "lighten"])
		user1.states.next("lighten")
		progressbar.states.next("fred")
		stijn.states.next("show")
		robert.states.next("hide")
	
# Scale avatar2 down on touch
user2.on Events.TouchStart, ->
	user2.animate
		properties:
			scale: 0.9
		curve: buttonanimation
...
user2.on Events.TouchEnd, ->
	user2.animate
		...
		user2.states.next("lighten")
		user1.states.next("darken", "lighten")
		progressbar.states.next("zlatan")
		stijn.states.next("hide")
		robert.states.next("hoi")
