...
Healthbook.Healthbookicon.on(Events.Click, function() {
  Healthbook.Notification.animate({
    properties: {
      y: -200
    },
  ...
  return Healthbook.Welcome.animate({
    properties: {
      y: 90
    },
...
Healthbook.Notification.on(Events.Click, function() {
  Healthbook.Notification.animate({
    properties: {
      x: 0,
      y: -200
  ...
  return Healthbook.Healthbookicon.visible = false;
});

/* On click of the Start Using Healthbook */

Healthbook.Start.on(Events.Click, function() {
  ...
  return Healthbook.Nutrition.animate({
    properties: {
      x: 0,
      y: 980
    },
...
Healthbook.Watch.on(Events.Click, function() {
  Healthbook.Emergencycard.animate({
    properties: {
      x: 0,
      y: 140
...
Healthbook.Emergencycard.on(Events.Click, function() {
  Healthbook.Emergencycard.animate({
    properties: {
      x: 0,
      y: 140
...
Healthbook.Activity.on(Events.Click, function() {
  Healthbook.Emergencycard.animate({
    properties: {
      x: 0,
      y: 1010
...
Healthbook.Cholestrol.on(Events.Click, function() {
  Healthbook.Emergencycard.animate({
    properties: {
      x: 0,
      y: 1010
...
Healthbook.Respiratoryrate.on(Events.Click, function() {
  Healthbook.Emergencycard.animate({
    properties: {
      x: 0,
      y: 1010
...
Healthbook.Heartrate.on(Events.Click, function() {
  Healthbook.Emergencycard.animate({
    properties: {
      x: 0,
      y: 1010
...
Healthbook.Sleep.on(Events.Click, function() {
  Healthbook.Emergencycard.animate({
    properties: {
      x: 0,
      y: 1010
...
Healthbook.Nutrition.on(Events.Click, function() {
  Healthbook.Emergencycard.animate({
    properties: {
      x: 0,
      y: 1010
