...
# -----------	
info = new Layer
	x:0, y:300, midX:screenMidX, width:640, height:188, backgroundColor: 'transparent'
info.html = 'Ed Chao'
info.style = {
	'font-family':'Roboto',
	'font-weight':'400',
...
logout = new Layer
	x:0, y:390, midX:screenMidX, width:640, height:188, backgroundColor: 'transparent'
logout.html = 'Logout'
logout.style = {
	'font-family':'Roboto',
	'font-weight':'400',
...
profile = new Layer 
	x:0, y:80, midX:screenMidX, width:188, height:188, image:"images/profile.png"
