...
album.states.add
	next:
		y: 248, originX: 0, originY: 0, scale: 1.7
...
list.on Events.Click, ->
	...
	if not open
		...
		circle.states.switch "next", curve: "ease", time: 0.8
		footerBg.states.switch "next", delay: 0.2
		header.states.switch "next", delay: 0.4
		footer.states.switch "next", delay: 0.4
...
back.on Events.Click, ->
	...
	if open
		...
		album.states.switch "default", delay: 0.2
		header.states.switch "default", delay: 0
		footer.states.switch "default", delay: 0
		footerBg.states.switch "default", delay: 0.2
		circle.states.switch "hide", delay: 0.6, curve: "ease", time: 0.8
