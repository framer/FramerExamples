...
scene1.states.add
	inactive: {opacity: 0.5, scale: 0.85 }
...
slideshowWrap = new Layer 
	x:0, y:0, width:slideshowWidth*(slideshow.length), height:slideshowHeight,
	superLayer: scene1
	
slideshowWrap.draggable.enabled = true
slideshowWrap.draggable.speedY = 0

for i in [0...slideshow.length]
	slidebox = new Layer
		superLayer: slideshowWrap
		x: slideshowWidth*(i), y: 0,
...
slideshowWrap.on Events.DragStart, ->
	slideshowOverlay.states.next()
	
slideshowWrap.on Events.DragEnd, ->
...
slideshowOverlayBG = new Layer
	...
	x: 0, y: 0, width: slideshowWidth, height: slideshowHeight,
	backgroundColor: "#000", opacity: 0.5
	
slideshowOverlayCountry = new Layer
	superLayer: slideshowOverlay,
	x: 0, y: (slideshowHeight/2)+20,
	width: slideshowWidth, height: 26,
	
slideshowOverlayCountry.states.add
	active: {y: (slideshowHeight/2)+100 }
...
bio = new Layer
	x: 0, y: 1030,
	width: slideshowWidth, height: 740
	backgroundColor: "#000"
...
bioReadMore = new Layer
	superLayer: bio,
	x: 0, y: 0,
	width: slideshowWidth, height: 100,
	backgroundColor: "transparent"
...
bioText = new Layer
	superLayer: bio,
	x: 0, y: 180,
	width: slideshowWidth, height: 500,
	backgroundColor: "transparent"
...
bio.on Events.Click, ->
	...
	slideshowOverlayCountry.states.next()
