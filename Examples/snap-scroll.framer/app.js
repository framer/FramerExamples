...
App = (function() {
  function App(options) {
    ...
    this.onStreamDragEnd = __bind(this.onStreamDragEnd, this);
    this.onStreamDragMove = __bind(this.onStreamDragMove, this);
    this.onStreamDragStart = __bind(this.onStreamDragStart, this);
    this.onCloseDetail = __bind(this.onCloseDetail, this);
    this.onOpenDetail = __bind(this.onOpenDetail, this);
...
Stream = (function(_super) {
  ...
  Stream.prototype._startListening = function() {
    ...
    _ref = this.options.layer.subLayers;
    _results = [];
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      post = _ref[_i];
      _results.push(post.on(Events.Click, (function(_this) {
...
Navigation = (function(_super) {
  ...
  function Navigation(options) {
    ...
    _ref = [this.statBarWhite, this.statBarBlack];
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      statBar = _ref[_i];
      statBar.states.add({
        show: {
