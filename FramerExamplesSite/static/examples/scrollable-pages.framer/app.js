...
var amountOfPages, bg, i, mediumLayers, pageComponent, pageIndex, pageIndicator, ref, scrollComponent, tabItem, tabItems;
...
pageIndicator = new Layer({
  height: 2,
  y: mediumLayers.navigationBar.height - 2,
...
pageComponent = new PageComponent({
  ...
  height: Screen.height - mediumLayers.navigationBar.height,
  width: Screen.width,
...
for (pageIndex = i = 0, ref = amountOfPages; 0 <= ref ? i < ref : i > ref; pageIndex = 0 <= ref ? ++i : --i) {
  ...
  tabItem = new Layer({
    ...
    y: mediumLayers.navigationBar.height - 86,
...
mediumLayers.navigationBar.on(Events.Click, function() {
