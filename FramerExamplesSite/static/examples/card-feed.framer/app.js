...
imageA = new Layer({
  ...
  image: "images/3CoEETpvQYO8x60lnZSA_rue.jpg"
});
...
imageB = new Layer({
  ...
  height: 1136,
  superLayer: container,
  image: "images/EOZpjI3oSqKPNnF2S4Tp_Untitled.jpg"
});

imageC = new Layer({
  x: 10,
  y: imageStartPos - screenHeight * 2,
  midX: screenMidX,
  scale: 1,
  width: 1704,
  height: 1136,
  superLayer: container,
  image: "images/lUUnN7VGSoWZ3noefeH7_Baker Beach-12.jpg"
});
...
cardB.on(Events.DragMove, function() {
  imageB.animate({
    properties: {
      y: imageStartPos + (this.y - cardStartPos) / parallaxVal
    },
...
cardC.on(Events.DragMove, function() {
  imageC.animate({
    properties: {
      y: imageStartPos + (this.y - cardStartPos) / parallaxVal
    },
